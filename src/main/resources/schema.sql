...
CREATE TABLE IF NOT EXISTS item_notes ( id BIGINT GENERATED ALWAYS AS IDENTITY PRIMARY KEY, text VARCHAR(2000), item_id BIGINT, creation_date timestamp, CONSTRAINT fk_item_notes_to_items FOREIGN KEY(item_id) REFERENCES items(id) );
